...
time: 2016.12.05 15:39:00
excerpt: 通俗的讲，移动设备上的viewport就是设备的屏幕上能用来显示我们的网页的那一块区域，在具体一点，就是浏览器上(也可能是一个app中的webview)用来显示网页的那部分区域，但viewport又不局限于浏览器可视区域的大小，它可能比浏览器的可视区域要大，也可能比浏览器的可视区域要小。
...
![viewport测试结果](http://i.imgur.com/wqmv7WQ.jpg)
...
![viewport](http://i.imgur.com/FGZAjIc.jpg)

![viewport](http://i.imgur.com/S7iLPbB.jpg)
...
target-densitydpi 值可以为一个数值或 high-dpi 、 medium-dpi、 low-dpi、 evice-dpi这几个字符串中的一个
...
![viewport](http://i.imgur.com/uvVKIS8.jpg)
...
![viewport](http://i.imgur.com/GytHwV4.jpg)
...
![viewport](http://i.imgur.com/rNO3jL9.jpg)

![viewport](http://i.imgur.com/zXph91s.jpg)

![viewport](http://i.imgur.com/1DFiu0T.jpg)
...
*本文转自：http://mdsa.51cto.com/art/201507/486480.htm*